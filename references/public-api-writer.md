...
5. Report back only `JOB DONE` — no file counts, no format breakdown, no listings in chat. Everything you found lives in the mirrored report tree you wrote.
